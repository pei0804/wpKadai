...
class MenuCollection extends Collection{
    ...
    protected function seekAndActivate(\Slimvc\Menu\MenuItem $item, $menu){
     ...
     * @param Slimvc\Menu\MenuItem $item
     * @param String $menu
     */
    public function addItem($name, \Slimvc\Menu\MenuItem $item){
