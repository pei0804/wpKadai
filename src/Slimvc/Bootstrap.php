...
use \Slimvc\Module\Manager as ModuleManager;
use \Slimvc\Menu\MenuManager;
...
/**
 * Slimvc Bootstrapper, initialize all the thing needed on the start
 */
class Bootstrap
{
    protected $app;
    ...
    /**
     * Setup Slimvc configuration and inject it to Slim instance
     * @param array $config
     */
    ...
    public function bootTwig($config)
    {
        ...
        $view->parserExtensions = array(
            ...
            new \Slimvc\TwigExtension\MenuRenderer()
        );
    }
