...
class Controller
{
    ...
    protected function loadBaseCss()
    {
        ...
        $this->loadCss('https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css', $options);
    }
    ...
    protected function loadBaseJs()
    {
        ...
        $this->loadJs('https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js', $options);
    }
